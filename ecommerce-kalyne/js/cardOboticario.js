let cadastroOboticario  = JSON.parse(localStorage.getItem('cadastroOboticario'));
...
if(cadastroOboticario){
    ...
    cadastroOboticario.forEach(element => {
        ...
        var marca = document.querySelector('#marca-oboticario');

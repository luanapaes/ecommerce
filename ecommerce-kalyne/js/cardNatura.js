//puxando o array do script principal
let cadastroNatura = JSON.parse(localStorage.getItem('cadastroNatura'));

if(cadastroNatura){

    //laço de repetição para arrays onde consigo pegar exatamente as informações de cada objeto armazenado nela
    cadastroNatura.forEach(element => {
        ...
        var marca = document.querySelector('#marca-natura');
